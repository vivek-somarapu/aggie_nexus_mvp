 ...
 * Legendary egg landing page (server component).
...
import EggLegendary from '@/components/eggs/EggLegendary';
...
export default async function LegendaryEggPage({ searchParams }: PageProps) {
  const { token } = await searchParams;

  const tokenStatus = await resolveTokenStatus(token, 'legendary');

 ...
 * Epic egg landing page (server component).
...
import EggEpic from '@/components/eggs/EggEpic';
...
export default async function EpicEggPage({ searchParams }: PageProps) {
  const { token } = await searchParams;

  const tokenStatus = await resolveTokenStatus(token, 'epic');

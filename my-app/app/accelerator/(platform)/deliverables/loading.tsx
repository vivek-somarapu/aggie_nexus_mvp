  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-8 animate-pulse">
      <div className="mb-8">
        ...
        <div className="h-6 w-36 bg-neutral-800 rounded mb-1" />
        ...
        {Array.from({ length: 4 }).map((_, weekIndex) => (
          <div key={weekIndex}>
            ...
            <div className="flex flex-col gap-2">
              {Array.from({ length: 3 }).map((_, deliverableIndex) => (
                <div key={deliverableIndex} className="flex items-center justify-between rounded-md border border-neutral-800 px-4 py-3">
